...
// Removed: import { projectDetailsHtml, initModalContentInteractions, openModal, closeModal } from './modal.js';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('preloaderHidden', function() {
        ...
        // Removed: projectImageAnchors.forEach(anchor => { ... }); (This was the modal-opening logic)
